  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={closeModal} title="이용 약관">
        ...
        <h3>1. 개인정보 수집 항목</h3>
        <p>설문이용(이하 사이트)은 설문조사 리워드 지급을 위해 아래와 같은 개인정보를 수집합니다.</p>
        <ul>
          <li>필수 항목: 전화번호</li>
        </ul>

        <h3>2. 개인정보의 수집 및 이용 목적</h3>
        <p>사이트는 수집한 개인정보를 다음의 목적을 위해 이용합니다.</p>
        <ul>
          <li>설문조사 참여자에게 리워드를 지급하기 위한 목적</li>
        </ul>

        <h3>3. 개인정보의 보유 및 이용 기간</h3>
        <p>사이트는 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</p>
        <ul>
          <li>보유 기간: 리워드 지급 완료 시점까지</li>
        </ul>

        <h3>4. 개인정보의 제3자 제공</h3>
        <p>사이트는 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.</p>
        <ul>
        ...
        <p>
          사이트는 원칙적으로 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 파기 절차 및
          방법은 다음과 같습니다.
        </p>
        <ul>
        ...
        <h3>6. 개인정보취급 위탁</h3>
        <p>사이트는 개인정보 취급 업무를 외부 업체에 위탁하여 운영하지 않습니다.</p>
        ...
        <h3>8. 개인정보 보호 책임자 및 담당자 연락처</h3>
        <p>
          사이트는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 이용자의 불만 처리 및 피해
          구제를 위하여 아래와 같이 개인정보 보호 책임자를 지정하고 있습니다.
        </p>
        <ul>
          <li>개인정보 보호 책임자: 정훈희 (팀 수인분당선)</li>
          <li>연락처: deca3248@gmail.com</li>
        </ul>
        <p>이 밖에 기타 개인정보침해의 신고, 상담은 아래의 기관에 문의하시기 바랍니다.</p>
        <ul>
        ...
        <p>본 약관은 2024년 08월 12일부터 시행됩니다.</p>
      </Modal>
